...
class ProfileAdvanced extends Component<
  {
    loading: boolean;
    projectInfoAndProfileAdvanced: AdvancedProfileData;
...
> {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'projectInfoAndProfileAdvanced/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { projectInfoAndProfileAdvanced, loading } = this.props;
    const {
      advancedOperation1,
      advancedOperation2,
      advancedOperation3,
    } = projectInfoAndProfileAdvanced;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
...
export default connect(
  ({
    ...
    projectInfoAndProfileAdvanced,
    loading: loading.effects['projectInfoAndProfileAdvanced/fetchAdvanced'],
  })
)(ProfileAdvanced);
